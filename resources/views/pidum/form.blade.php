...
@section('content')
    ...
    <form class="form-horizontal" action="{{ url('/pidum/input') }}" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="tgl_reg" value="{{ old('tgl_reg') }}">
          <span class="error">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="surat_dakwaan" value="{{ old('surat_dakwaan') }}">
          <span class="error">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" name="amar_putusan" value="{{ old('amar_putusan') }}">
          <span class="error">
